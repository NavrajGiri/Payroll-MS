<div>
        <center>
                ...
                Dob: <input type="date" wire:model="dob"><br><br>
                ...
                Account_NO: <input type="number" wire:model="accouont_no"><br><br>
                Grade_Id: <input type="number" wire:model="grade_id"><br><br>
                nagarik_lagani_kosh_No: <input type="number" wire:model="nagarik_lagani_kosh_no"><br><br>
