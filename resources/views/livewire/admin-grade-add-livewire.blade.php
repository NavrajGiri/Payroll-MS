...
<div class="bg-blue-200 min-h-screen flex items-center">
    <div class="w-full">
      ...
      <div class="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2">
          ...
          <div class="mb-5">
             <label for="grade_name" class="block mb-2 font-bold text-gray-600">Grade number</label>
             <input type="text" id="grade_name" wire:model='grade_name' placeholder=" Grade number" class="border border-gray-300 shadow p-3 w-full rounded mb-">
           </div>

           <div class="mb-5">
             <label for="salary_amount" class="block mb-2 font-bold text-gray-600">salary amount</label>
             <input type="numberxt" id="salary_amount" wire:model='salary_amount' placeholder="salary amount" class="border border-gray-300 shadow p-3 w-full rounded mb-">
            </div>
